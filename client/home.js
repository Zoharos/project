...
import {NavBar, LoginDialog, HomePageCard,styles} from './components';
import saleCardImg from 'Imgs/sale-sign.jpg';
import rentCardImg from 'Imgs/rent-sign.jpg';
    ...
    render()
    {
      ...
      const buttonsArray =  buttonLoggedOutArray.map((buttonString, index) => (
        ...
        <div>
            ...
            <div className="right homeCard">
                <HomePageCard cardImage={"/"+rentCardImg} leftBtnTitle="היכנס" rightBtnTitle="קרא עוד" title="השכרה" content="לוח דירות להשכרה ממתווכים הראשון מסוגו בארץ"/>
            </div>
            <div className="homeCard">
                <HomePageCard cardImage={"/"+saleCardImg} leftBtnTitle="היכנס" rightBtnTitle="קרא עוד" title="מכירה" content="לוח דירות למכירה ממתווכים הראשון מסוגו בארץ"/>
            </div>
        </div>
      )
    }
